...
static inline void initialize_sanitize_handlers()
{
	...
	sanitize_handlers[IORING_OP_POLL_REMOVE] = sanitize_sqe_addr;
	...
	sanitize_handlers[IORING_OP_TIMEOUT_REMOVE] = sanitize_sqe_addr;
	sanitize_handlers[IORING_OP_ACCEPT] = sanitize_sqe_addr;
	sanitize_handlers[IORING_OP_ASYNC_CANCEL] = sanitize_sqe_addr;
	sanitize_handlers[IORING_OP_LINK_TIMEOUT] = sanitize_sqe_addr;
	sanitize_handlers[IORING_OP_CONNECT] = sanitize_sqe_addr;
	sanitize_handlers[IORING_OP_FALLOCATE] = sanitize_sqe_addr;
	...
	sanitize_handlers[IORING_OP_FADVISE] = sanitize_sqe_addr;
